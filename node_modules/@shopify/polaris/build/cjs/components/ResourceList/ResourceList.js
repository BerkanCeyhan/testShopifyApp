...
var ResourceList_module = require('./ResourceList.scss.js');
...
function ResourceList({
  ...
  const bulkActionClassNames = css.classNames(ResourceList_module.default.BulkActionsWrapper, isBulkActionsSticky && ResourceList_module.default.BulkActionsWrapperSticky);
  ...
  const resourceListWrapperClasses = css.classNames(ResourceList_module.default.ResourceListWrapper, Boolean(bulkActionsMarkup) && selectMode && bulkActions && ResourceList_module.default.ResourceListWrapperWithBulkActions);
  ...
  }, filterControlMarkup, headerMarkup, bulkActionsMarkup, listMarkup, emptySearchStateMarkup, emptyStateMarkup, loadingWithoutItemsMarkup, paginationMarkup), /*#__PURE__*/React.createElement("div", {
