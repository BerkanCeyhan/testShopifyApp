...
var BulkActions_module = require('./BulkActions.scss.js');
...
class BulkActionsInner extends React.PureComponent {
  ...
  render() {
    ...
    const group = /*#__PURE__*/React.createElement(reactTransitionGroup.Transition, {
      ...
      const groupClassName = css.classNames(BulkActions_module.default.Group, !isSticky && BulkActions_module.default['Group-not-sticky'], !measuring && isSticky && BulkActions_module.default[`Group-${status}`], measuring && BulkActions_module.default['Group-measuring']);
