...
var Badge_module = require('./Badge.scss.js');
...
function Badge({
  ...
  const className = css.classNames(Badge_module.default.Badge, tone && Badge_module.default[css.variationName('tone', tone)], size && size !== DEFAULT_SIZE && Badge_module.default[css.variationName('size', size)], withinFilter && Badge_module.default.withinFilter);
