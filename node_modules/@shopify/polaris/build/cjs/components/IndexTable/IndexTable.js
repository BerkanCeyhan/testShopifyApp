...
var IndexTable_module = require('./IndexTable.scss.js');
...
function IndexTableBase({
  ...
  const stickyTableClassNames = css.classNames(IndexTable_module.default.StickyTable, condensed && IndexTable_module.default['StickyTable-condensed']);
  const shouldShowBulkActions = bulkActionsSelectable && selectedItemsCount;
  const bulkActionClassNames = css.classNames(IndexTable_module.default.BulkActionsWrapper, isBulkActionsSticky && IndexTable_module.default.BulkActionsWrapperSticky);
  ...
  const stickyHeaderMarkup = /*#__PURE__*/React.createElement("div", {
    ...
    const selectAllActionsClassName = css.classNames(IndexTable_module.default.SelectAllActionsWrapper, condensed && IndexTable_module.default['StickyTableHeader-condensed'], isSticky && IndexTable_module.default['StickyTableHeader-isSticky']);
  ...
  const scrollBarWrapperClassNames = css.classNames(IndexTable_module.default.ScrollBarContainer, condensed && IndexTable_module.default.scrollBarContainerCondensed, hideScrollContainer && IndexTable_module.default.scrollBarContainerHidden);
  ...
  const tableWrapperClassNames = css.classNames(IndexTable_module.default.IndexTableWrapper, hideScrollContainer && IndexTable_module.default['IndexTableWrapper-scrollBarHidden'], Boolean(bulkActionsMarkup) && selectMode && IndexTable_module.default.IndexTableWrapperWithBulkActions);
...
function IndexTable({
  ...
  }, /*#__PURE__*/React.createElement(IndexTableBase, indexTableBaseProps, children)), paginationMarkup);
}
