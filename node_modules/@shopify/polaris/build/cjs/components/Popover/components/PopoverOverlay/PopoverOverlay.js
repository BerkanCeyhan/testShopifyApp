...
var Popover_module = require('../../Popover.scss.js');
...
class PopoverOverlay extends React.PureComponent {
  constructor(props) {
    ...
    this.renderPopover = overlayDetails => {
      ...
      const className = css.classNames(Popover_module.default.Popover, positioning === 'above' && Popover_module.default.positionedAbove, fullWidth && Popover_module.default.fullWidth, measuring && Popover_module.default.measuring, hideOnPrint && Popover_module.default['PopoverOverlay-hideOnPrint']);
  ...
  render() {
    ...
    const className = css.classNames(Popover_module.default.PopoverOverlay, transitionStatus === TransitionStatus.Entering && Popover_module.default['PopoverOverlay-entering'], transitionStatus === TransitionStatus.Entered && Popover_module.default['PopoverOverlay-open'], transitionStatus === TransitionStatus.Exiting && Popover_module.default['PopoverOverlay-exiting']);
