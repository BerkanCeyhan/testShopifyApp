@charset "UTF-8";
:root { --polaris-version-number: '12.6.0'; }
...
.Polaris-Avatar--styleSix { background: var(--p-color-avatar-six-bg-fill); color: var(--p-color-avatar-six-text-on-bg-fill); }

.Polaris-Avatar--styleSix svg, .Polaris-Avatar--styleSix text { color: var(--p-color-avatar-six-text-on-bg-fill); }

.Polaris-Avatar--styleSeven { background: var(--p-color-avatar-seven-bg-fill); color: var(--p-color-avatar-seven-text-on-bg-fill); }

.Polaris-Avatar--styleSeven svg, .Polaris-Avatar--styleSeven text { color: var(--p-color-avatar-seven-text-on-bg-fill); }
...
.Polaris-Text--magic { color: var(--p-color-text-magic); }

.Polaris-Text__magic--subdued { color: var(--p-color-text-magic-secondary); }
...
.Polaris-Text--headingLg { font-size: var(--p-font-size-500); line-height: var(--p-font-line-height-600); font-weight: var(--p-font-weight-semibold); }
...
.Polaris-Text--bodyXs { font-size: var(--p-text-body-xs-font-size); font-weight: var(--p-text-body-xs-font-weight); line-height: var(--p-text-body-xs-font-line-height); }
...
.Polaris-Icon svg { fill: currentColor; }

.Polaris-Icon--toneInherit svg { color: inherit; }

.Polaris-Icon--toneBase svg { color: var(--p-color-icon); }

.Polaris-Icon--toneSubdued svg { color: var(--p-color-icon-secondary); }

.Polaris-Icon--toneCaution svg { color: var(--p-color-icon-caution); }

.Polaris-Icon--toneWarning svg { color: var(--p-color-icon-warning); }

.Polaris-Icon--toneCritical svg { color: var(--p-color-icon-critical); }

.Polaris-Icon--toneInteractive svg { color: var(--p-color-icon-emphasis); }

.Polaris-Icon--toneInfo svg { color: var(--p-color-icon-info); }

.Polaris-Icon--toneSuccess svg { color: var(--p-color-icon-success); }

.Polaris-Icon--tonePrimary svg { color: var(--p-color-icon-brand); }

.Polaris-Icon--toneEmphasis svg { color: var(--p-color-icon-emphasis); }

.Polaris-Icon--toneMagic svg { color: var(--p-color-icon-magic); }

.Polaris-Icon--toneTextCaution svg { color: var(--p-color-text-caution); }

.Polaris-Icon--toneTextWarning svg { color: var(--p-color-text-warning); }

.Polaris-Icon--toneTextCritical svg { color: var(--p-color-text-critical); }

.Polaris-Icon--toneTextInfo svg { color: var(--p-color-text-info); }

.Polaris-Icon--toneTextPrimary svg { color: var(--p-color-text-brand); }

.Polaris-Icon--toneTextSuccess svg { color: var(--p-color-text-success); }

.Polaris-Icon--toneTextMagic svg { color: var(--p-color-text-magic); }

.Polaris-Icon__Svg, .Polaris-Icon__Img { position: relative; display: block; width: 100%; max-width: 100%; max-height: 100%; }

.Polaris-Icon__Placeholder { padding-bottom: 100%; background: var(--p-color-bg-fill-tertiary); border-radius: var(--p-border-radius-100); }
...
.Polaris-Button:hover { background: var(--p-color-bg-fill-hover); outline: var(--p-border-width-025) solid transparent; }
...
.Polaris-Button.Polaris-Button--pressed { background: var(--p-color-bg-fill-selected); box-shadow: var(--p-shadow-inset-200); color: var(--p-color-text); border-color: var(--p-color-border-inverse); }
...
.Polaris-Button:focus:not(.Polaris-Button--variantPrimary):not(.Polaris-Button--variantTertiary):not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain):not(.Polaris-Button--pressed), .Polaris-Button:focus-visible:not(.Polaris-Button--variantPrimary):not(.Polaris-Button--variantTertiary):not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain):not(.Polaris-Button--pressed) { box-shadow: var(--pc-button-shadow); }
...
.Polaris-Button:not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain) .Polaris-Button__Content { width: 100%; }

.Polaris-Button.Polaris-Button--variantPrimary .Polaris-Button__Content { font-weight: var(--p-font-weight-semibold); }
...
.Polaris-Button--toneCritical, .Polaris-Button--variantPrimary, .Polaris-Button--variantTertiary { position: relative; background: var(--pc-button-color); border-width: 0; border-color: transparent; box-shadow: var(--p-shadow-200); color: var(--pc-button-text); }

.Polaris-Button--toneCritical::after, .Polaris-Button--variantPrimary::after, .Polaris-Button--variantTertiary::after { content: ''; position: absolute; z-index: 1; top: -0.0625rem; right: -0.0625rem; bottom: -0.0625rem; left: -0.0625rem; display: block; pointer-events: none; box-shadow: 0 0 0 -0.0625rem var(--p-color-border-focus); border-radius: var(--p-border-radius-100); }

.Polaris-Button--toneCritical:hover, .Polaris-Button--variantPrimary:hover, .Polaris-Button--variantTertiary:hover { background: var(--pc-button-color-hover); border-color: transparent; color: var(--pc-button-text); }

.Polaris-Button--toneCritical:focus, .Polaris-Button--variantPrimary:focus, .Polaris-Button--variantTertiary:focus { border-color: transparent; box-shadow: var(--p-shadow-200); }

.Polaris-Button--toneCritical:active, .Polaris-Button--variantPrimary:active, .Polaris-Button--variantTertiary:active { background: var(--pc-button-color-active); border-color: transparent; box-shadow: var(--p-shadow-200); }

.Polaris-Button--toneCritical.Polaris-Button--pressed, .Polaris-Button--variantPrimary.Polaris-Button--pressed, .Polaris-Button--variantTertiary.Polaris-Button--pressed { color: var(--pc-button-text); background: var(--pc-button-color-depressed); border-color: transparent; box-shadow: var(--p-shadow-200); }

.Polaris-Button--toneCritical.Polaris-Button--pressed:hover, .Polaris-Button--toneCritical.Polaris-Button--pressed:focus, .Polaris-Button--variantPrimary.Polaris-Button--pressed:hover, .Polaris-Button--variantPrimary.Polaris-Button--pressed:focus, .Polaris-Button--variantTertiary.Polaris-Button--pressed:hover, .Polaris-Button--variantTertiary.Polaris-Button--pressed:focus { background: var(--pc-button-color-depressed); box-shadow: var(--p-shadow-200); }

.Polaris-Button--toneCritical.Polaris-Button--disabled, .Polaris-Button--variantPrimary.Polaris-Button--disabled, .Polaris-Button--variantTertiary.Polaris-Button--disabled { color: var(--p-color-text-disabled); box-shadow: none; border-color: transparent; }

.Polaris-Button--toneCritical.Polaris-Button--disabled svg, .Polaris-Button--variantPrimary.Polaris-Button--disabled svg, .Polaris-Button--variantTertiary.Polaris-Button--disabled svg { fill: var(--p-color-icon-disabled); }

.Polaris-Button--variantPrimary { --pc-button-color: var(--p-color-bg-fill-brand); --pc-button-text: var(--p-color-text-brand-on-bg-fill); --pc-button-color-hover: var(--p-color-bg-fill-brand-hover); --pc-button-color-active: var(--p-color-bg-fill-brand-active); --pc-button-color-depressed: var(--p-color-bg-fill-brand-active); }

.Polaris-Button--variantPrimary::before { content: ''; position: absolute; left: 0; right: 0; top: 0; bottom: 0; background: linear-gradient(180deg, rgba(255, 255, 255, 0.07) 80%, rgba(255, 255, 255, 0.15) 100%); box-shadow: var(--p-shadow-button-primary); /* stylelint-disable-next-line polaris/border/declaration-property-unit-disallowed-list -- custom radius */ border-radius: 0.5625rem; /* stylelint-disable-next-line polaris/motion/declaration-property-unit-disallowed-list -- custom transition time */ transition: opacity 75ms cubic-bezier(0.19, 0.91, 0.38, 1); }

.Polaris-Button--variantPrimary:not(.Polaris-Button--disabled) { box-shadow: none; }

.Polaris-Button--variantPrimary:hover { --pc-button-text: var(--p-color-text-brand-on-bg-fill-hover); }

.Polaris-Button--variantPrimary:hover::before { box-shadow: var(--p-shadow-button-primary); }

.Polaris-Button--variantPrimary:hover svg { fill: var(--p-color-text-brand-on-bg-fill-hover); }

.Polaris-Button--variantPrimary:active { --pc-button-text: var(--p-color-text-brand-on-bg-fill-active); background: var(--pc-button-color-active); box-shadow: var(--p-shadow-button-primary-inset); }

.Polaris-Button--variantPrimary:active::before { opacity: 1; background: linear-gradient(180deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0) 100%); box-shadow: var(--p-shadow-button-primary-inset); }

.Polaris-Button--variantPrimary:active svg { fill: var(--p-color-text-brand-on-bg-fill-active); }

.Polaris-Button--variantPrimary.Polaris-Button--disabled { color: var(--p-color-text-brand-on-bg-fill-disabled); background: var(--p-color-bg-fill-brand-disabled); box-shadow: none; }

.Polaris-Button--variantPrimary.Polaris-Button--disabled::before { display: none; }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical::before, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess::before { left: 0.03125rem; right: 0.03125rem; top: 0.03125rem; bottom: 0.03125rem; border-radius: inherit; background: none; }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:hover, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:hover { --pc-button-text: var(--p-color-text-brand-on-bg-fill-hover); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:hover svg, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:hover svg { fill: var(--p-color-text-brand-on-bg-fill-hover); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:active, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:active { --pc-button-text: var(--p-color-text-brand-on-bg-fill-active); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:active::before, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:active::before { opacity: 0; }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:active svg, .Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:active svg { fill: var(--p-color-text-brand-on-bg-fill-active); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical { --pc-button-color: var(--p-color-bg-fill-critical); --pc-button-text: var(--p-color-text-critical-on-bg-fill); --pc-button-color-hover: var(--p-color-bg-fill-critical-hover); --pc-button-color-active: var(--p-color-bg-fill-critical-active); --pc-button-color-depressed: var(--p-color-bg-fill-critical-active); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical::before { box-shadow: var(--p-shadow-button-primary-critical); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:not(.Polaris-Button--disabled) { box-shadow: none; }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical svg { fill: var(--p-color-text-critical-on-bg-fill); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:active { box-shadow: var(--p-shadow-button-primary-critical-inset); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical:hover::before { box-shadow: var(--p-shadow-button-primary-critical-hover); }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical.Polaris-Button--disabled::before { display: none; }

.Polaris-Button--variantPrimary.Polaris-Button--toneCritical.Polaris-Button--disabled svg { fill: var(--p-color-text-brand-on-bg-fill-disabled); }

.Polaris-Button--variantPrimary.Polaris-Button--toneSuccess { --pc-button-color: var(--p-color-bg-fill-success); --pc-button-text: var(--p-color-text-success-on-bg-fill); --pc-button-color-hover: var(--p-color-bg-fill-success-hover); --pc-button-color-active: var(--p-color-bg-fill-success-active); --pc-button-color-depressed: var(--p-color-bg-fill-success-active); box-shadow: none; }

.Polaris-Button--variantPrimary.Polaris-Button--toneSuccess::before { box-shadow: var(--p-shadow-button-primary-success); }

.Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:hover::before { box-shadow: var(--p-shadow-button-primary-success-hover); }

.Polaris-Button--variantPrimary.Polaris-Button--toneSuccess:active { box-shadow: var(--p-shadow-button-primary-success-inset); }

.Polaris-Button--variantPrimary svg { fill: var(--p-color-text-success-on-bg-fill); }

.Polaris-Button--toneCritical { --pc-button-color: var(--p-color-bg-fill); --pc-button-text: var(--p-color-text-critical); --pc-button-color-hover: var(--p-color-bg-fill-hover); --pc-button-color-active: var(--p-color-bg-fill-active); --pc-button-color-depressed: var(--p-color-bg-fill-active); box-shadow: var(--pc-button-shadow); }

.Polaris-Button--toneCritical svg { fill: var(--pc-button-text); }

.Polaris-Button--toneCritical.Polaris-Button--disabled svg { fill: var(--p-color-text-disabled); }

.Polaris-Button--toneCritical:focus, .Polaris-Button--toneCritical:focus-visible { box-shadow: var(--pc-button-shadow); }

.Polaris-Button--variantTertiary { --pc-button-color: transparent; --pc-button-text: var(--p-color-text); --pc-button-color-hover: var(--p-color-bg-fill-transparent-hover); --pc-button-color-active: var(--p-color-bg-fill-transparent-active); box-shadow: none; }

.Polaris-Button--variantTertiary path { fill: var(--pc-button-text); }

.Polaris-Button--variantTertiary:is(:hover, :focus, :active) { color: var(--p-color-text-emphasis-active); box-shadow: none; }

.Polaris-Button--variantTertiary.Polaris-Button--disabled { --pc-button-text: var(--p-color-text-disabled); background: transparent; color: var(--p-color-text-disabled); }

.Polaris-Button--variantTertiary.Polaris-Button--disabled svg { fill: var(--p-color-icon-disabled); }

.Polaris-Button--variantTertiary:active { --pc-button-text: var(--p-color-text); color: var(--pc-button-text); box-shadow: none; }

.Polaris-Button--variantTertiary:active .Polaris-Button__Content { transform: translateY(0); }

.Polaris-Button--variantTertiary:hover { --pc-button-text: var(--p-color-text); box-shadow: none; }

.Polaris-Button--variantTertiary:hover, .Polaris-Button--variantTertiary:focus:not(.Polaris-Button--disabled) { text-decoration: none; color: var(--pc-button-text); }

.Polaris-Button--variantTertiary::before { display: none; }

.Polaris-Button--variantTertiary.Polaris-Button--toneCritical { --pc-button-color: transparent; --pc-button-text: var(--p-color-text-critical); --pc-button-color-hover: var(--p-color-bg-fill-transparent-hover); --pc-button-color-active: var(--p-color-bg-fill-transparent-active); }

.Polaris-Button--variantTertiary.Polaris-Button--toneCritical:hover, .Polaris-Button--variantTertiary.Polaris-Button--toneCritical:active { --pc-button-text: var(--p-color-text-critical); }

.Polaris-Button--variantTertiary.Polaris-Button--toneCritical.Polaris-Button--toneCritical { box-shadow: none; }

.Polaris-Button--variantTertiary.Polaris-Button--toneCritical.Polaris-Button--disabled { --pc-button-text: var(--p-color-text-disabled); }

.Polaris-Button--variantTertiary.Polaris-Button--iconOnly { margin: calc(var(--p-space-100)*-1); }

.Polaris-Button--variantTertiary.Polaris-Button--iconOnly path { fill: var(--p-color-icon-secondary); }

.Polaris-Button--variantTertiary.Polaris-Button--iconOnly:active path, .Polaris-Button--variantTertiary.Polaris-Button--iconOnly:hover path { fill: var(--p-color-icon); }

.Polaris-Button--variantTertiary.Polaris-Button--iconOnly.Polaris-Button--toneCritical path { fill: var(--p-color-text-critical); }

.Polaris-Button--variantTertiary.Polaris-Button--iconOnly.Polaris-Button--disabled path { fill: var(--p-color-icon-disabled); }
...
.Polaris-Button--variantPrimary.Polaris-Button--disabled svg { fill: var(--pc-button-text); }

.Polaris-Button--variantPlain, .Polaris-Button--variantMonochromePlain { /* stylelint-disable-next-line polaris/conventions/polaris/custom-property-allowed-list -- custom vertical margin */ margin-block: calc(var(--pc-button-vertical-padding)*-1); margin-inline: calc(var(--p-space-300)*-1); background: transparent; border: 0; box-shadow: none; color: var(--p-color-text-emphasis); }

.Polaris-Button--variantPlain svg, .Polaris-Button--variantMonochromePlain svg { fill: var(--p-color-icon-emphasis); }

.Polaris-Button--variantPlain > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain > .Polaris-Button__Content { font-size: var(--p-font-size-325); font-weight: var(--p-font-weight-regular); line-height: var(--p-font-line-height-400); }

.Polaris-Button--variantPlain > .Polaris-Button__Content::after, .Polaris-Button--variantMonochromePlain > .Polaris-Button__Content::after { content: none; }

.Polaris-Button--variantPlain:hover, .Polaris-Button--variantPlain:focus:not(.Polaris-Button--disabled), .Polaris-Button--variantMonochromePlain:hover, .Polaris-Button--variantMonochromePlain:focus:not(.Polaris-Button--disabled) { color: var(--p-color-text-emphasis-hover); background: transparent; box-shadow: none; }

.Polaris-Button--variantPlain:hover svg, .Polaris-Button--variantPlain:focus:not(.Polaris-Button--disabled) svg, .Polaris-Button--variantMonochromePlain:hover svg, .Polaris-Button--variantMonochromePlain:focus:not(.Polaris-Button--disabled) svg { fill: var(--p-color-icon-emphasis-hover); }

.Polaris-Button--variantPlain:hover:not(.Polaris-Button--removeUnderline), .Polaris-Button--variantPlain:focus:not(.Polaris-Button--disabled):not(.Polaris-Button--removeUnderline), .Polaris-Button--variantMonochromePlain:hover:not(.Polaris-Button--removeUnderline), .Polaris-Button--variantMonochromePlain:focus:not(.Polaris-Button--disabled):not(.Polaris-Button--removeUnderline) { text-decoration: underline; }

.Polaris-Button--variantPlain.Polaris-Button--pressed, .Polaris-Button--variantPlain:active, .Polaris-Button--variantMonochromePlain.Polaris-Button--pressed, .Polaris-Button--variantMonochromePlain:active { color: var(--p-color-text-brand-on-bg-fill-active); background-color: transparent; box-shadow: none; }

.Polaris-Button--variantPlain.Polaris-Button--pressed > .Polaris-Button__Content, .Polaris-Button--variantPlain:active > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain.Polaris-Button--pressed > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain:active > .Polaris-Button__Content { transform: translateY(0); }

.Polaris-Button--variantPlain.Polaris-Button--pressed svg, .Polaris-Button--variantPlain:active svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--pressed svg, .Polaris-Button--variantMonochromePlain:active svg { fill: var(--p-color-text-brand-on-bg-fill-active); }

@media (-ms-high-contrast: active) { .Polaris-Button--variantPlain.Polaris-Button--pressed, .Polaris-Button--variantPlain:active, .Polaris-Button--variantMonochromePlain.Polaris-Button--pressed, .Polaris-Button--variantMonochromePlain:active { outline: none; } }

.Polaris-Button--variantPlain:focus-visible, .Polaris-Button--variantMonochromePlain:focus-visible { outline: none; }

.Polaris-Button--variantPlain:focus-visible::after, .Polaris-Button--variantMonochromePlain:focus-visible::after { content: none; }

@media (-ms-high-contrast: active) { .Polaris-Button--variantPlain:focus-visible, .Polaris-Button--variantMonochromePlain:focus-visible { outline: none; } }

.Polaris-Button--variantPlain:focus-visible > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain:focus-visible > .Polaris-Button__Content { outline: var(--p-border-width-050) solid var(--p-color-border-focus); outline-offset: var(--p-space-050); border-radius: var(--p-border-radius-150); }

@media (-ms-high-contrast: active) { .Polaris-Button--variantPlain:focus-visible > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain:focus-visible > .Polaris-Button__Content { outline: var(--p-border-width-050) dotted; } }

.Polaris-Button--variantPlain:focus-visible:not(:active) > .Polaris-Button__Content::after, .Polaris-Button--variantMonochromePlain:focus-visible:not(:active) > .Polaris-Button__Content::after { content: none; }

.Polaris-Button--variantPlain:active:not(.Polaris-Button--iconOnly) > .Polaris-Button__Content, .Polaris-Button--variantPlain.Polaris-Button--pressed:not(.Polaris-Button--iconOnly) > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain:active:not(.Polaris-Button--iconOnly) > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain.Polaris-Button--pressed:not(.Polaris-Button--iconOnly) > .Polaris-Button__Content { padding: var(--p-space-050) var(--p-space-100); margin: calc(var(--p-space-050)*-1) calc(var(--p-space-100)*-1); background: transparent; border-radius: var(--p-border-radius-100); padding: unset; margin: unset; }

.Polaris-Button--variantPlain.Polaris-Button--fullWidth, .Polaris-Button--variantMonochromePlain.Polaris-Button--fullWidth { margin-left: 0; margin-right: 0; }

.Polaris-Button--variantPlain.Polaris-Button--disabled, .Polaris-Button--variantMonochromePlain.Polaris-Button--disabled { color: var(--p-color-text-disabled); background: none; box-shadow: none; }

.Polaris-Button--variantPlain.Polaris-Button--disabled.Polaris-Button--loading, .Polaris-Button--variantMonochromePlain.Polaris-Button--disabled.Polaris-Button--loading { color: transparent; }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical { color: var(--p-color-text-critical); box-shadow: none; }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical svg { fill: var(--p-color-text-critical); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical:hover, .Polaris-Button--variantPlain.Polaris-Button--toneCritical:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled), .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:hover, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled) { color: var(--p-color-text-critical-hover); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical:hover svg, .Polaris-Button--variantPlain.Polaris-Button--toneCritical:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled) svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:hover svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled) svg { fill: var(--p-color-text-critical-hover); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical:active, .Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--pressed, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:active, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--pressed { color: var(--p-color-text-critical-active); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical:active svg, .Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--pressed svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical:active svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--pressed svg { fill: var(--p-color-text-critical-active); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--disabled, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--disabled { color: var(--p-color-text-disabled); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--disabled svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--disabled svg { fill: var(--p-color-icon-disabled); }

.Polaris-Button--variantPlain.Polaris-Button--sizeMicro, .Polaris-Button--variantMonochromePlain.Polaris-Button--sizeMicro { margin: calc(var(--pc-button-vertical-padding)*-1) calc(var(--p-space-300)*-1); }

.Polaris-Button--variantPlain.Polaris-Button--sizeMicro > .Polaris-Button__Content, .Polaris-Button--variantMonochromePlain.Polaris-Button--sizeMicro > .Polaris-Button__Content { font-size: var(--p-font-size-325); }

.Polaris-Button--variantPlain.Polaris-Button--sizeSlim, .Polaris-Button--variantMonochromePlain.Polaris-Button--sizeSlim { margin: calc(var(--pc-button-vertical-padding)*-1) calc(var(--p-space-300)*-1); }

.Polaris-Button--variantPlain.Polaris-Button--sizeLarge, .Polaris-Button--variantMonochromePlain.Polaris-Button--sizeLarge { margin-block: calc(var(--p-space-200)*-1); margin-inline: calc(var(--p-space-500)*-1); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly { margin: 0; padding: 0; min-height: var(--p-font-line-height-500); min-width: var(--p-font-line-height-500); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly svg { fill: var(--p-color-icon-secondary); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly:hover svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly:hover svg { fill: var(--p-color-icon-hover); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly:active svg, .Polaris-Button--variantPlain.Polaris-Button--iconOnly.Polaris-Button--pressed svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly:active svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly.Polaris-Button--pressed svg { fill: var(--p-color-icon-active); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly:focus svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly:focus svg { fill: var(--p-color-icon-hover); }

.Polaris-Button--variantPlain.Polaris-Button--iconOnly.Polaris-Button--disabled svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--iconOnly.Polaris-Button--disabled svg { fill: var(--p-color-icon-disabled); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly svg { fill: var(--p-color-text-critical); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:hover svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:hover svg { fill: var(--p-color-text-critical-hover); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled) svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:focus:not(:active):not(.Polaris-Button--pressed):not(.Polaris-Button--disabled) svg { fill: var(--p-color-text-critical); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:active svg, .Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly.Polaris-Button--pressed svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly:active svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly.Polaris-Button--pressed svg { fill: var(--p-color-text-critical-active); }

.Polaris-Button--variantPlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly.Polaris-Button--disabled svg, .Polaris-Button--variantMonochromePlain.Polaris-Button--toneCritical.Polaris-Button--iconOnly.Polaris-Button--disabled svg { fill: var(--p-color-icon-disabled); }

.Polaris-Button--variantPlain .Polaris-Button__Icon, .Polaris-Button--variantMonochromePlain .Polaris-Button__Icon { margin-left: 0; margin-right: 0; }

.Polaris-Button--variantPlain .Polaris-Button__Icon:last-child, .Polaris-Button--variantMonochromePlain .Polaris-Button__Icon:last-child { margin-left: var(--p-space-050); }
...
.Polaris-Button--iconOnly.Polaris-Button--sizeLarge { padding-left: var(--p-space-200); padding-right: var(--p-space-200); }
...
.Polaris-Button--sizeLarge { /* stylelint-disable-next-line polaris/conventions/polaris/custom-property-allowed-list -- custom height */ min-height: var(--pc-button-large-min-height); /* stylelint-disable-next-line polaris/conventions/polaris/custom-property-allowed-list -- custom height */ min-width: var(--pc-button-large-min-height); padding-block: var(--p-space-200); padding-inline: var(--p-space-300); }
...
.Polaris-Button.Polaris-Button--variantMonochromePlain { color: currentColor; }

.Polaris-Button.Polaris-Button--variantMonochromePlain svg { fill: currentColor; }

.Polaris-Button.Polaris-Button--variantMonochromePlain:hover, .Polaris-Button.Polaris-Button--variantMonochromePlain:focus, .Polaris-Button.Polaris-Button--variantMonochromePlain:active { color: currentColor; }

.Polaris-Button.Polaris-Button--variantMonochromePlain:hover svg, .Polaris-Button.Polaris-Button--variantMonochromePlain:focus svg, .Polaris-Button.Polaris-Button--variantMonochromePlain:active svg { fill: currentColor; }

.Polaris-Button.Polaris-Button--variantMonochromePlain.Polaris-Button--loading .Polaris-Button__Text { visibility: hidden; }

.Polaris-Button.Polaris-Button--variantMonochromePlain.Polaris-Button--disabled { color: var(--p-color-text-disabled); }

.Polaris-Button.Polaris-Button--variantMonochromePlain .Polaris-Button__Text:not(.Polaris-Button--removeUnderline) { text-decoration: underline; }

.Polaris-Button:is([aria-expanded='true']):is([aria-owns]):not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain):not(.Polaris-Button--variantTertiary):not(.Polaris-Button--variantPrimary) { --pc-button-shadow: var(--p-shadow-inset-200); background: var(--p-color-bg-fill-active); }

.Polaris-Button:is([aria-expanded='true']):is([aria-owns]):not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain):not(.Polaris-Button--variantTertiary):not(.Polaris-Button--variantPrimary) .Polaris-Button__Content { transform: translateY(0.0625rem); }

.Polaris-Button:is([aria-expanded='true']):is([aria-owns]):not(.Polaris-Button--variantPlain):not(.Polaris-Button--variantMonochromePlain):not(.Polaris-Button--variantTertiary):not(.Polaris-Button--variantPrimary):hover { box-shadow: var(--pc-button-shadow); }

.Polaris-Button:is([aria-expanded='true']):is([aria-owns]):is(.Polaris-Button--variantTertiary) { background: var(--p-color-bg-fill-transparent-active); }

[data-buttongroup-variant='segmented'] { /* stylelint-disable selector-max-combinators -- necessary nesting depth */ }
...
[data-buttongroup-variant='segmented'] > :not(:first-child) .Polaris-Button.Polaris-Button--variantPrimary { margin-left: calc(var(--p-space-025)*-1); }
...
.Polaris-TextField:focus-within .Polaris-TextField__ClearButton { display: block; visibility: visible; opacity: 1; }

.Polaris-TextField:not(:focus-within) .Polaris-TextField__ClearButton { display: none; visibility: hidden; opacity: 0; }
...
.Polaris-TextField--slim .Polaris-TextField__Input, .Polaris-TextField--slim .Polaris-TextField__Backdrop { min-height: 1.75rem; padding-block: var(--p-space-050); }

/* stylelint-disable -- override focus ring offset by increasing specificity */
.Polaris-TextField--slim.Polaris-TextField--borderless.Polaris-TextField--slim.Polaris-TextField--borderless .Polaris-TextField__Input, .Polaris-TextField--slim.Polaris-TextField--borderless.Polaris-TextField--slim.Polaris-TextField--borderless .Polaris-TextField__Backdrop { outline-offset: 0; }
...
.Polaris-TextField__VerticalContent { position: relative; z-index: var(--pc-text-field-contents); color: var(--p-color-text-secondary); padding: var(--p-space-200) var(--p-space-200) 0 var(--p-space-200); max-height: 8.75rem; overflow: auto; border: var(--p-border-width-025) solid transparent; width: 100%; }
...
.Polaris-Badge--toneMagic { background-color: var(--p-color-bg-fill-magic-secondary); color: var(--p-color-text-magic); }

.Polaris-Badge--toneMagic svg { fill: var(--p-color-icon-magic); }
...
.Polaris-ActionMenu-SecondaryAction a, .Polaris-ActionMenu-SecondaryAction button { position: relative; background-color: var(--p-color-bg-fill-tertiary) !important; box-shadow: none !important; border: none; border-radius: var(--p-border-radius-200) !important; padding: var(--p-space-100) var(--p-space-300); min-height: 1.75rem; /* stylelint-disable-next-line selector-no-qualifying-type -- add expanded styling */ }
...
.Polaris-ActionMenu-SecondaryAction a:active, .Polaris-ActionMenu-SecondaryAction a[aria-expanded='true'], .Polaris-ActionMenu-SecondaryAction button:active, .Polaris-ActionMenu-SecondaryAction button[aria-expanded='true'] { background-color: var(--p-color-bg-fill-tertiary-active) !important; box-shadow: var(--p-shadow-inset-200) !important; }
...
.Polaris-Pagination.Polaris-Pagination--table { border-top: 0.0625rem solid var(--p-color-border); }
...
/* Increase specificity for icon override in Filters */
.Polaris-Filters-SearchField__Spinner.Polaris-Filters-SearchField__Spinner svg { display: block; fill: var(--p-color-bg-fill-brand); }
...
@media (max-width: 30.6225em) { .Polaris-Filters__Container { border-top-left-radius: 0; border-top-right-radius: 0; } }
...
.Polaris-Filters__FiltersInner { overflow: auto; white-space: nowrap; padding: var(--p-space-300) var(--p-space-200) var(--p-space-500); }
...
.Polaris-FooterHelp { display: flex; justify-content: center; margin: var(--p-space-500); width: auto; }
...
.Polaris-FormLayout__Item { flex: 1 1 auto; }

.Polaris-FormLayout__Item.Polaris-FormLayout--grouped { min-width: 13.75rem; }

.Polaris-FormLayout__Item.Polaris-FormLayout--condensed { flex-basis: 6.875rem; min-width: 6.875rem; }
...
.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary'] { --pc-color-text: rgba(48, 48, 48, 1); --pc-button-text: var(--pc-color-text); --pc-button-color: rgba(255, 255, 255, 1); --pc-button-color-hover: rgba(250, 250, 250, 1); --pc-button-color-active: rgba(247, 247, 247, 1); --pc-button-color-depressed: rgba(247, 247, 247, 1); --pc-button-color-disabled: rgba(255, 255, 255, 0.2); --pc-button-shadow-inset: 0 0.125rem 0.0625rem 0 rgba(26, 26, 26, 0.2) inset,
      0.0625rem 0 0.0625rem 0 rgba(26, 26, 26, 0.12) inset,
      -0.0625rem 0 0.0625rem 0 rgba(26, 26, 26, 0.12) inset; }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary']::before, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary']::before { top: 0; right: 0; bottom: 0; left: 0; }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary']:hover, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary']:hover { --pc-button-text: var(--pc-color-text); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary']:active, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary']:active { --pc-button-text: var(--pc-color-text); box-shadow: var(--pc-button-shadow-inset); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary'][class*='Polaris-Button--pressed'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary'][class*='Button-pressed'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary'][class*='Polaris-Button--pressed'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary'][class*='Button-pressed'] { box-shadow: var(--pc-button-shadow-inset); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary'][class*='Polaris-Button--disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantPrimary'][class*='Button-disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary'][class*='Polaris-Button--disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantPrimary'][class*='Button-disabled'] { background: var(--pc-button-color-disabled); color: var(--p-color-text-secondary); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary'] { --pc-button-color: var(--p-color-bg-fill-inverse); --pc-button-color-hover: var(--p-color-bg-fill-inverse-hover); --pc-button-color-active: var(--p-color-bg-fill-inverse-active); --pc-button-text: var(--p-color-text-inverse); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary']::after, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary']::after { content: none; }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary']:hover, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary']:hover { --pc-button-text: var(--p-color-text-inverse); }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary']:active, .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary']:active { --pc-button-text: var(--p-color-text-inverse); box-shadow: none; }

.Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary'][class*='Polaris-Button--disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Polaris-Button--variantTertiary'][class*='Button-disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary'][class*='Polaris-Button--disabled'], .Polaris-Frame-ContextualSaveBar__ActionContainer [class*='Button-variantTertiary'][class*='Button-disabled'] { --pc-button-text: var(--p-color-text-secondary); background: var(--pc-button-color); }
...
.Polaris-Frame__Skip > a:hover { background: var(--p-color-bg-fill-hover); outline: var(--p-border-width-025) solid transparent; }
...
.Polaris-Frame__Skip > a.Polaris-Frame--pressed { background: var(--p-color-bg-fill-selected); box-shadow: var(--p-shadow-inset-200); color: var(--p-color-text); border-color: var(--p-color-border-inverse); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-success); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneWarning::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneWarning .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-warning); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-critical); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-secondary); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child { --pc-index-table-checkbox-width: var(--p-space-500); --pc-index-table-checkbox-width-sm: calc(var(--pc-index-table-checkbox-width) + var(--p-width-050)); --pc-index-table-checkbox-padding-left: var(--p-space-300); --pc-index-table-checkbox-padding-right: var(--p-width-150); --pc-index-table-checkbox-child-offset: calc(var(--pc-index-table-checkbox-width) + var(--pc-index-table-checkbox-padding-left)); --pc-index-table-checkbox-child-offset-sm: calc(var(--pc-index-table-checkbox-width-sm) + var(--pc-index-table-checkbox-padding-left)); --pc-table-shifted-checkbox-z-index: 32; }

.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first { left: var(--pc-index-table-checkbox-child-offset); z-index: var(--pc-table-shifted-checkbox-z-index); }

@media (max-width: 30.6225em) { .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first { left: var(--pc-index-table-checkbox-child-offset-sm); } }

.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first::before { content: ''; position: absolute; display: block; width: calc(var(--pc-index-table-checkbox-child-offset) + var(--pc-index-table-checkbox-padding-right)); height: 100%; top: 0; right: var(--pc-index-table-checkbox-child-offset); background-color: var(--p-color-bg-surface); }

@media (max-width: 30.6225em) { .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first::before { width: calc(var(--pc-index-table-checkbox-child-offset-sm) + var(--pc-index-table-checkbox-padding-right)); right: var(--pc-index-table-checkbox-child-offset-sm); } }

.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { --pc-index-table-cell-padding: var(--p-space-150); padding-left: calc(var(--pc-index-table-checkbox-child-offset) + var(--pc-index-table-cell-padding)); }

@media (max-width: 30.6225em) { .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { padding-left: calc(var(--pc-index-table-checkbox-child-offset-sm) + var(--pc-index-table-cell-padding)); } }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-selected); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-success-active); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-critical-active); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--selected.Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-secondary-active); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-hover); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSuccess .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-success-hover); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneCritical .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-critical-hover); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneWarning::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneWarning .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-warning-hover); }
...
.Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued::before, .Polaris-IndexTable__TableRow.Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled).Polaris-IndexTable__TableRow--child.Polaris-IndexTable--toneSubdued .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-secondary-hover); }
...
.Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child:nth-child(2n)::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child:nth-child(2n) .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-secondary); }
...
.Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child.Polaris-IndexTable__TableRow--selected:nth-child(2n)::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child.Polaris-IndexTable__TableRow--selected:nth-child(2n) .Polaris-IndexTable__TableCell--first::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child.Polaris-IndexTable__TableRow--selected:nth-child(2n + 1)::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--child.Polaris-IndexTable__TableRow--selected:nth-child(2n + 1) .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-brand-selected); }
...
.Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--hovered.Polaris-IndexTable__TableRow--selected:nth-child(2n)::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--hovered.Polaris-IndexTable__TableRow--selected:nth-child(2n) .Polaris-IndexTable__TableCell--first::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--hovered.Polaris-IndexTable__TableRow--selected:nth-child(2n + 1)::before, .Polaris-IndexTable__ZebraStriping .Polaris-IndexTable__TableRow--hovered.Polaris-IndexTable__TableRow--selected:nth-child(2n + 1) .Polaris-IndexTable__TableCell--first::before { background-color: var(--p-color-bg-surface-brand-hover); }
...
.Polaris-IndexTable__Table--unselectable { --pc-index-table-checkbox-width: var(--p-space-500); --pc-index-table-checkbox-width-sm: calc(var(--pc-index-table-checkbox-width) + var(--p-width-050)); --pc-index-table-checkbox-padding-left: var(--p-space-300); --pc-index-table-checkbox-child-offset: calc(var(--pc-index-table-checkbox-width) + var(--pc-index-table-checkbox-padding-left)); --pc-index-table-checkbox-child-offset-sm: calc(var(--pc-index-table-checkbox-width-sm) + var(--pc-index-table-checkbox-padding-left)); }
...
.Polaris-IndexTable__Table--unselectable.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell:first-child { padding-left: var(--pc-index-table-checkbox-child-offset); }

@media (max-width: 30.6225em) { .Polaris-IndexTable__Table--unselectable.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell:first-child { padding-left: var(--pc-index-table-checkbox-child-offset-sm); } }

.Polaris-IndexTable__Table--unselectable .Polaris-IndexTable__TableRow--child .Polaris-IndexTable__TableCell:not(.Polaris-IndexTable__TableCell--flush):first-child { padding-left: var(--pc-index-table-checkbox-child-offset); }
...
.Polaris-Tag.Polaris-Tag--clickable:disabled { background: var(--p-color-bg-fill-disabled); cursor: default; pointer-events: none; color: var(--p-color-text-disabled); }
...
.Polaris-Tag__Button:hover { background: var(--p-color-bg-fill-tertiary-hover); color: var(--p-color-icon-hover); outline: var(--p-border-width-025) solid transparent; }
...
.Polaris-Tag__Button:focus-visible { background: var(--p-color-bg-fill-tertiary-hover); color: var(--p-color-icon-hover); }
...
.Polaris-LegacyFilters-ConnectedFilterControl__MoreFiltersButtonContainer.Polaris-LegacyFilters-ConnectedFilterControl--onlyButtonVisible { padding-left: 0; }
...
.Polaris-LegacyFilters-ConnectedFilterControl__AuxiliaryContainer { flex-grow: 0; margin-left: var(--p-space-200); }

@media (min-width: 48em) { .Polaris-LegacyFilters-ConnectedFilterControl__AuxiliaryContainer { margin-left: 0; } }
...
.Polaris-Navigation__SecondaryAction { display: flex; align-items: center; height: calc(100% - var(--p-space-100)); padding: calc(var(--p-space-200) - var(--p-space-050)) var(--p-space-200); border-radius: var(--p-border-radius-200); border: none; position: relative; }
...
.Polaris-Header-Title.Polaris-Header-Title__TitleWithSubtitle { margin-top: 0; }

.Polaris-Header-Title__TitleWrapper { display: flex; flex-wrap: wrap; align-items: center; row-gap: var(--p-space-200); padding-block: var(--p-space-050); }

.Polaris-Header-Title__TitleWrapper .Polaris-Header-Title { display: inline; margin-right: var(--p-space-200); }

.Polaris-Header-Title__TitleWrapper .Polaris-Header-Title > * { display: inline; }
...
.Polaris-Select--toneMagic .Polaris-Select__Content { color: var(--p-color-text-magic); }

.Polaris-Select--toneMagic .Polaris-Select__InlineLabel { color: inherit; }

.Polaris-Select--toneMagic .Polaris-Select__Backdrop { border-color: var(--p-color-border-magic-secondary); background-color: var(--p-color-bg-surface-magic); }

.Polaris-Select--toneMagic .Polaris-Select__Icon svg { fill: var(--p-color-icon-magic); }

.Polaris-Select--toneMagic:not(.Polaris-Select--disabled):not(.Polaris-Select--error):not(:focus-within):hover .Polaris-Select__Backdrop { border-color: var(--p-color-border-magic-secondary-hover); background-color: var(--p-color-bg-surface-magic-hover); }

.Polaris-Select--toneMagic:not(.Polaris-Select--disabled):not(.Polaris-Select--error) .Polaris-Select__Input:focus-visible ~ .Polaris-Select__Content { color: var(--p-color-text); }

.Polaris-Select--toneMagic:not(.Polaris-Select--disabled):not(.Polaris-Select--error) .Polaris-Select__Input:focus-visible ~ .Polaris-Select__Content .Polaris-Select__Icon svg { fill: var(--p-color-icon-secondary); }
...
.Polaris-SkeletonDisplayText__DisplayText { --pc-skeleton-display-text-height: var(--p-font-line-height-500); --pc-skeleton-display-text-height-not-condensed: var(
  ...
  ); max-width: var(--pc-skeleton-display-text-max-width, 120px); display: flex; background-color: var(--p-color-bg-fill-tertiary); border-radius: var(--p-border-radius-100); }
