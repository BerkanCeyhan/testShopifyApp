...
function Button({
  ...
  const className = classNames(styles.Button, fullWidth && styles.fullWidth, icon && children == null && styles.iconOnly, isDisabled && styles.disabled, loading && styles.loading, pressed && !disabled && !url && styles.pressed, removeUnderline && styles.removeUnderline, size && size !== DEFAULT_SIZE && styles[variationName('size', size)], textAlign && styles[variationName('textAlign', textAlign)], tone && styles[variationName('tone', tone)], variant && styles[variationName('variant', variant)]);
