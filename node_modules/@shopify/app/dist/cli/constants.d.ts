export declare const environmentVariableNames: {
    ...
    disableGraphiQLExplorer: string;
};
...
export declare const urlNamespaces: {
    readonly devTools: ".shopify";
};
export declare const ports: {
    readonly graphiql: 3457;
};
export declare const EsbuildEnvVarRegex: RegExp;
