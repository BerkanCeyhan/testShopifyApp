...
async function getInfoBreakdown(apiKey, token, localRegistration, toCreate, dashboardOnly) {
    ...
    const appModuleVersionsNonConfig = activeAppVersion.app.activeAppVersion?.appModuleVersions.filter((module) => module.specification && module.specification?.experience !== 'configuration') || [];
    const nonDashboardRemoteRegistrations = appModuleVersionsNonConfig
    ...
    const onlyRemote = appModuleVersionsNonConfig
