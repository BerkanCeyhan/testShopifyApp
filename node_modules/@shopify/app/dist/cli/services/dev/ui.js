...
export async function renderDev({ processes, previewUrl, app, abortController, graphiqlUrl, graphiqlPort, developerPreview, }) {
    if (terminalSupportsRawMode(process.stdin)) {
        return render(React.createElement(Dev, { processes: processes, abortController: abortController, previewUrl: previewUrl, app: app, graphiqlUrl: graphiqlUrl, graphiqlPort: graphiqlPort, developerPreview: developerPreview }), {
            exitOnCtrlC: false,
        });
    }
    else {
