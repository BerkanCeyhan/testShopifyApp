...
import { validateInnerSubscriptions, validateTopLevelSubscriptions, httpsRegex, } from '../../utilities/app/config/webhooks.js';
...
const validateUrl = (zodType, { httpsOnly = false, message = 'Invalid url' } = {}) => {
...
const removeTrailingSlash = (arg) => typeof arg === 'string' && arg.endsWith('/') ? arg.replace(/\/+$/, '') : arg;
