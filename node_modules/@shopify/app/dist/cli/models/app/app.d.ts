...
export declare const WebhookSubscriptionSchema: zod.ZodObject<{
    topic: zod.ZodString;
    uri: zod.ZodOptional<zod.ZodEffects<zod.ZodUnion<[zod.ZodString, zod.ZodString, zod.ZodString]>, string, unknown>>;
...
declare const DeclarativeWebhooksSchema: zod.ZodObject<{
...
export declare const AppSchema: zod.ZodObject<{
    ...
    access: zod.ZodOptional<zod.ZodObject<{
        direct_api_offline_access: zod.ZodOptional<zod.ZodBoolean>;
    }, "strip", zod.ZodTypeAny, {
